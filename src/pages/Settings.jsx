      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-[0_4px_12px_rgba(199,91,60,0.08)]">
          ...
          <p className="text-[10px] text-charcoal-light mt-1">
            {lang === 'es'
              ? 'Recetas de: Minimalist Baker, Forks Over Knives, Pick Up Limes, A Little Bit Yummy, FODMAP Everyday, Sharon Palmer RDN. Datos nutricionales de USDA FoodData Central y fuentes originales.'
              : 'Recipes from: Minimalist Baker, Forks Over Knives, Pick Up Limes, A Little Bit Yummy, FODMAP Everyday, Sharon Palmer RDN. Nutritional data from USDA FoodData Central and original sources.'}
          </p>
          <p className="text-[10px] text-charcoal-light mt-1">
